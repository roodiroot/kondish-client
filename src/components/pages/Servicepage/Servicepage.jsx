        ...
        <>
            <div className="service">
                ...
                <div className="service__blockHeader blockHeader">
                    <div className="blockHeader__title">Стоимость услуг монтажа и установки</div>
                </div>
            ...
            <div className="working">
                ...
                <div className="working__topLine">
                    <div className="working__block">
                        ...
                        <div className="working__text">доставка оборудования и инструментов</div>
                        <div className="working__text">бурение отверстия для проводки коммуникаций</div>
                        <div className="working__text">обмотка коммуникаций тефлоновой лентой</div>
                        <div className="working__text">прокладывание коммуникаций</div>
                        <div className="working__text">монтаж кронштейнов для наружного блока</div>
                        <div className="working__text">установка наружного блока</div>
                        <div className="working__text">сбор и вывоз мусора</div>
                        <div className="working__text">заполнение сопутствующих документов и актов</div>
                    </div>
                    <div className="working__block">
                        <div className="working__blockTitle">Этап 2</div>
                        <div className="working__text">производится развальцовка труб</div>
                        <div className="working__text">монтаж кронштейнов для внутреннего блока</div>
                        ...
                        <div className="working__text">подключение, запуск и проверка оборудования</div>
                        <div className="working__text">заполнение сопутствующих документов и актов</div>
                    </div>
                </div>
                <div className="working__bottomLIne">
                    <div className="working__blockHeader blockHeader">
                        <div className="blockHeader__title">Преимущества установки в два этапа:</div>
                    </div>
                    <div className="working__block2">
                        <div className="working__descriptionRow">
                            <div className="workingIcon icon-000000"></div>
                            <div className="working__description">Отсутствие лишних кабелей и коммуникаций в помещении</div>
                        </div>
                        <div className="working__descriptionRow">
                            <div className="workingIcon icon-000000"></div>
                            <div className="working__description">Возможность установки климатической системы практически в любом месте</div>
                        </div>
                        <div className="working__descriptionRow">
                            <div className="workingIcon icon-000000"></div>
                            <div className="working__description">Возможность установки внешнего блока в удобном для доступа месте</div>
                        </div>
                        <div className="working__descriptionRow">
                            <div className="workingIcon icon-000000"></div>
                            <div className="working__description">Риск загрязнения интерьера и повреждения ремонта минимален</div>
                        </div>
                        <div className="working__descriptionRow">
                            <div className="workingIcon icon-000000"></div>
                            <div className="working__description">Возможность вывода дренажа в нужное место</div>
                        </div>
                    </div>
                    <div className="service__button">
                        <Button onClick={e => setModal(true)} >Заказать услугу</Button>
