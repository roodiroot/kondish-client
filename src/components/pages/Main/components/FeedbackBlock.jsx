    ...
    return (
        <div className="feedbackBlock">
            <div className="feedbackBlock__blockHeader blockHeader">
                ...
                <div className="blockHeader__subtitle">Заполните форму, и мы с радостью с вами свяжемся и ответим на все интересующие вас вопросы</div>
            </div>
            <div className="feedbackBlock__body">
                <Input placeholder='Имя*' value={name} setValue={setName} />
                <Input number placeholder='Номер телефона*' value={number} setValue={setNumber} />
